...
import numpy as np
from Deep_Neural_Network.dnn import DNN, Layer
...
if __name__ == "__main__":
    ...
    #
    # # hidden layers
    # dnn.add_layer(Layer(28*28, 16, ReLU_Activation()))
    # dnn.add_layer(Layer(16, 16, ReLU_Activation()))
    #
    # # output layer
    # dnn.add_layer(Layer(16, 10, Activation_Softmax_Loss_Categorical_Cross_Entropy()))
    #
    # dnn.train(train_X, train_y)
    #
    # dnn.show_stats()
    # dnn.store_dnn('DNN_16_16')

    dnn = DNN()
    loaded_dnn = dnn.load_dnn('DNN_16_16')
